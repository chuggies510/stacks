...
**Released from outside (ChuggiesMart S262, 2026-07-31, mbp):** 0.78.1 committed the Codex plugin/marketplace manifests left uncommitted in this tree, and recorded the `5c33e28` CLAUDE.md + `templates/library/CLAUDE.md` cut that had shipped without a release line. 0.78.2 merged `chore/skill-descriptions`, rewriting all nine skill descriptions as "Use when" triggers and cutting the always-loaded description budget 4,463 → 1,077 bytes (Codex 2% skills-context ceiling). Both pushed. Nothing else in this tree was touched.
