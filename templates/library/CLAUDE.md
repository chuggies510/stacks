...
- `/stacks:ingest {stack}` — process new sources into topic guides
- `/stacks:refine {stack}` — check quality, completeness, suggest research direction
- `/stacks:new {name}` — scaffold a new empty stack
