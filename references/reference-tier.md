...
into first-class synthesized articles, copy it into `{stack}/sources/incoming/` and
use a compatible Stacks harness to catalog it. No special path is needed; the
chapter file is already reference-grade text.
